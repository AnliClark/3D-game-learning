...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		[Header("Cinemachine")]
		[Tooltip("The follow target set in the Cinemachine Virtual Camera that the cam will follow")]
		...
		private void CameraRotation()
		{
			...
			if (_input.look.sqrMagnitude >= _threshold)
			{
				...
				_cinemachineTargetPitch = ClampAngle(_cinemachineTargetPitch, -10f, 30f);
